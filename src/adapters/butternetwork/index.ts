...
const contractAddresses = {
  ...
  unichain: {
    ...
    tokens: {
      ...
      ETH: "0x4200000000000000000000000000000000000006",
      "USD₮0": "0x9151434b16b9763660705744891fa906f660ecc5",
...
const tokenWithdrawalParams: PartialContractEventParams = {
  ...
  abi: [
    "event mapSwapOut(uint256 indexed fromChain, uint256 indexed toChain, bytes32 orderId, bytes token, bytes from, bytes to, uint256 amount, bytes swapData)",
  ],
  logKeys: {
    blockNumber: "blockNumber",
    txHash: "transactionHash",
  ...
  if (chain === "tron") {
    return async (fromBlock: number, toBlock: number) => {
      ...
      try {
        ...
        const eventNames = ["mapSwapIn", "mapSwapOut"];
...
const adapter: BridgeAdapter = {
  ...
  unchain: constructParams("unichain"),
