...
0x72Ce9c846789fdB6fC1f34aC4AD25Dd9ef7031ef is Arbitrum One: L1 Gateway Router
  -deposits of:
    ...
    -NO ETH
  -NO withdrawals
deposits of ETH are missing?? may need to look at all txs to 0x4Dbd4fc535Ac27206064B68FfCf827b0A60BAB3f and get ETH transferred
*/
...
// maybe should change to monitor each contract separately
...
const erc20WithdrawalEventParams: PartialContractEventParams =
  constructTransferParams("0xa3A7B6F88361F48403514059F1F16C8E78d60EeC", false);

const customGatewayWithdrawalEventParams: PartialContractEventParams =
  constructTransferParams("0xcEe284F754E854890e311e3280b767F80797180d", false);

const wethWithdrawalEventParams: PartialContractEventParams =
  constructTransferParams("0xd92023E9d9911199a6711321D1277285e6d4e2db", false);

const daiWithdrawalEventParams: PartialContractEventParams =
  constructTransferParams("0xA10c7CE4b876998858b1a9E12b10092229539400", false);
